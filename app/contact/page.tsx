...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      {/* <div className="relative bg-primary text-gray py-20 overflow-hidden">
       
        <div className="absolute inset-0 bg-primary z-0"></div>
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=2000&q=80')] bg-cover bg-center z-0"></div>
        
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 drop-shadow-md text-light">Contact Us</h1>
          <p className="text-xl md:text-2xl max-w-3xl mx-auto text-light">
     ...
     Contact Us
            ...
            <div className="p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:8446713030" className="text-gray-700 hover:text-blue-600 transition-colors">
                      8446713030
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:abhishekjuniorcollegemoshi@gmail.com" className="text-gray-700 hover:text-blue-600 transition-colors">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    PLOT NO-2, SECTOR NO-6, NEAR JALVAYU VIHAR, MOSHI PRADHIKARAN, PUNE – 412105
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-100 hover:bg-primary p-3 rounded-full transition-colors">
              ...
              {isSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <Button 
                    ...
                    className="bg-primary-600 hover:bg-gray-700"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <Button 
                      type="submit" 
                      className="w-full bg-primary-600 hover:bg-blue-700 py-3 text-lg font-medium"
                    >
        ...
        <div className="mt-12 bg-white rounded-xl shadow-md overflow-hidden">
          <div className="p-6">
            ...
            <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3769.3240580207986!2d73.90182981422165!3d18.644632987483195!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c16555d26857%3A0x71de1636bce3c4e5!2sAbhishek%20Arts%2C%20Commerce%20%26%20Science%20Junior%20College!5e0!3m2!1sen!2sin!4v1679654854877!5m2!1sen!2sin"
                width="100%"
                height="450"
                style={{ border: 0 }}
                loading="lazy"
      ...
      <div className="container mx-auto px-4 pb-12 text-center">
        <Link href="/">
          <Button variant="outline" className="border-primary-600 text-gray-600 hover:bg-blue-50">
